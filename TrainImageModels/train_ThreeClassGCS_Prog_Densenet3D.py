...
# path_to_save_model_dir = "/home/ubuntu/tenerife/data/ZZ_ICH_PrognosisMICCAI/Models/ThreeClassGCS_Prognosis"
# path_to_save_results = '/home/ubuntu/tenerife/data/ZZ_ICH_PrognosisMICCAI/Results/ThreeClassGCS_Prognosis'
# name_file = "ThreeClassGCS_Prognosis"
...
for fold, (train_index, test_index) in enumerate(skf.split(images_all, labels_all)):
    ...
    if not os.path.isfile(path_to_save_model):
        model = PrognosisICH_ThreeClassGCS_Model(image_shape=image_shape, depth=depth, spatial_dims=3, in_channels=1, num_classes_binary=1, dropout_prob=0.2)
        ...
        for epoch in range(max_epochs):
            ...
            for batch_data in train_loader:
                ...
                combined_loss = 0.6*binary_loss + 0.4*ordinal_loss_gcs
            ...
            if (epoch + 1) % val_interval == 0:
                ...
                print("Predictions count in prognosis:", dict(zip(unique, counts)))
    ...
    fold_metrics_df = pd.concat([fold_metrics_df, pd.DataFrame([[fold, test_gcs_balanced_accuracy, 
                                                                 ...
                                                                 test_specificity, test_NPV, test_precision, test_recall, test_f1]],
                                                                   columns=fold_metrics_df.columns)], ignore_index=True)
