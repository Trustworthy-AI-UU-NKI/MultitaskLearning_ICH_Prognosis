...
path_to_save_results = '/home/ubuntu/tenerife/data/ZZ_ICH_PrognosisMICCAI/Results/BinaryGCS_BinaryAge_Prognosis/SaliencyMapsPrognosis'
name_file_saved_model = "BinaryGCSBinaryAge_Prognosis_MulticlassOutput"
name_file="PredictionsTestFold0_GuidedGradCam_BinaryGCSBinaryAge_Prognosis"
...
for fold, (train_index, test_index) in enumerate(skf.split(images_all, labels_all)):
    ...
    with torch.no_grad():
        for test_data in test_loader:
            ...
            # print("Patient:", test_patientID, "True label:", test_labels.cpu().numpy(), "Predicted label:", predicted_test.cpu().numpy(), "Probability:", probabilities_test.cpu().numpy())
